...
screen.title('Used Car Inventory')

# maximum animation speed
turtle.tracer(2, 0)


car_details = """The following car is in the inventory:
    Make: BMW
    Model: 2001
    Mileage: 70000
    Price: $22000.0
...
def draw_initial_details():
    ...
    turtle.penup()
    turtle.goto(-630, 300)
    turtle.write("USED CAR INVENTORY", align="left", font=("Serif", 16, "bold"))
    turtle.goto(-630, 290)
    turtle.write("------------------------------", font=("Serif", 16, "bold"))
...
def draw_car():
    ...
    turtle.penup()
    turtle.goto(-630, 300)
    turtle.write("USED CAR INVENTORY", font=("Calibri", 14, "bold"))
    turtle.goto(-630, 290)
...
def draw_suv():
    ...
    suv.speed(0)
    suv.pendown()
    suv.fillcolor(red_amount, green_amount, black_amount)
    suv.begin_fill()
...
def draw_flowers():
    turtle.speed(0.3)#enable drawing of flowers faster thus increasing speed of displaying the cars
    turtle.ht()
    turtle.penup()
    turtle.goto(500, -150)
    turtle.pendown()

    for i in range(8):#number of flowers shown
        turtle.penup()
        turtle.left(180)
        turtle.fd(110)
        turtle.pendown()
...
root = tk.Tk()
root.geometry("250x200")  # Adjusting the window size
root.title("Buttons")

car_button = tk.Button(root, text="See Car", command=draw_car, width=10, height=2, bg="purple", fg="white", relief=tk.FLAT)  
car_button.pack(padx=6.5, pady=5)  # Removed 'side' parameter

suv_button = tk.Button(root, text="See SUV", command=draw_suv, width=10, height=2, bg="purple", fg="white", relief=tk.FLAT)  
suv_button.pack(padx=6.5, pady=5)  # Removed 'side' parameter

truck_button = tk.Button(root, text="See Truck", command=draw_truck, width=10, height=2, bg="purple", fg="white", relief=tk.FLAT)  
truck_button.pack(padx=6.5, pady=5)  # Removed 'side' parameter
